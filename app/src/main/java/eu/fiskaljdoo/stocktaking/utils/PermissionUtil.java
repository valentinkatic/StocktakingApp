...
public class PermissionUtil {
    ...
    public static boolean isGranted(Activity act, String permission) {
        return !Tools.needRequestPermission() || (act.checkSelfPermission(permission) == PackageManager.PERMISSION_GRANTED);
    }

    public static boolean isCameraGranted(Activity act) {
        return isGranted(act, Manifest.permission.CAMERA);
    }

    public static boolean isStorageGranted(Activity act) {
        return isGranted(act, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }
